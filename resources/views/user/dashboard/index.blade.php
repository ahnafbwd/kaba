    ...
    <div class="col-md-12 grid-margin">
      <div class="row">
        <div class="col-12 col-xl-8 mb-4 mb-xl-0">
          <h3 class="font-weight-bold">Selamat Datang {{ Auth::guard('web')->user()->nama_lengkap }}</h3>
          <h6 class="font-weight-normal mb-0">Bahasa Arab itu mudah dipelajari! Yuk belajar sekarang! <span class="text-primary">Daftar disini</span></h6>
        </div>
    ...
    <div class="col-md-6 grid-margin stretch-card">
      <div class="card tale-bg">
        <div class="card-people mt-auto">
          <img src="userdashboard/images/dashboard/people.svg" alt="people">
