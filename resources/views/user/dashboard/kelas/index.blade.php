        ...
        <div class="row">
            <div class="col-md-12 mb-3">
                <div class="card bg-primary">
                    <div class="card-body">
                        <p class="card-title h3 font-weight-400 text-white">Program
                            {{ $siswa->kelompok->program->nama_program }}</p>
                    ...
                    <div class="card-body d-flex justify-content-between align-items-center"
                        style="overflow-x: auto; white-space: nowrap; scroll-snap-type: x mandatory; -webkit-overflow-scrolling: touch;">
                        <a href="/user/jadwal" class="btn btn-light flex-fill mr-2"
                            style=" margin-right: 8px; scroll-snap-align: center;">
                            <p class="text-primary font-weight-bold">Jadwal</p>
                        </a>
                        <a href="#" class="btn btn-light flex-fill mr-2"
                            style=" margin-right: 8px; scroll-snap-align: center;">
                            <p class="text-primary font-weight-bold">Absensi</p>
                        </a>
                        <a href="/user/tugas" class="btn btn-light flex-fill mr-2"
                            style=" margin-right: 8px; scroll-snap-align: center;">
                            <p class="text-primary font-weight-bold">Tugas</p>
                        </a>
                        <a href="#" class="btn btn-light flex-fill" style=" scroll-snap-align: center;">
                            <p class="text-primary font-weight-bold">Informasi</p>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-8">
                ...
                @foreach ($kodeMateris as $kodeMateri)
                    ...
                    @if ($materi)
                        <div class="">
                            <a href="/user/materi/{{ $materi->kode_materi }}"
                                class="btn btn-info btn-fw bg-gray w-full mb-1 pl-4 pr-4 pt-0 pb-0 justify-content-center align-items-between mt-2 mb-2">
            ...
            <div class="col-md-4">
                <div class="card bg-primary">
                    <div class="card-body ">
                        ...
                        <a href="{{ $siswa->kelompok->link_wa }}" class="btn btn-fw bg-green w-full btn-success mr-2"
                            style=" margin-right: 8px; scroll-snap-align: center;">
                            <p class="text-white font-weight-bold"><i class="fab fa-whatsapp mr-2"></i>Link Grup Whatsapp
                            </p>
                        </a>
                    </div>
                </div>
