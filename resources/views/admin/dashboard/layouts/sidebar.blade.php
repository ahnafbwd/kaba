    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#pengguna" aria-expanded="false" aria-controls="pengguna">
                ...
                <span class="menu-title ml-3">Pengguna</span>
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#akademik" aria-expanded="false" aria-controls="akademik">
                ...
                <span class="menu-title ml-3">Akademik</span>
                <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="akademik">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/tingkat">
                            Tingkat
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/angkatan">
                            Angkatan
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/kelompok">
                            Kelas
                        </a>
                    </li>
                    <li class="nav-item">
